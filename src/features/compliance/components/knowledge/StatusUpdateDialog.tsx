...
import { StatusUpdateValidationSchema } from "../../schema/knowledge.schema";
    ...
    onSubmit: async (values, { resetForm }) => {
      try {
        ...
        const res = await mutation(
          `knowledge/document?document_id=${documentId}&collection_id=${collectionId}&file_update=false`,
          {
            method: "PUT",
            isAlert: false,
            body: requestBody
