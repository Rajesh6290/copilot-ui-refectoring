...
const FrameworkSelectionComponent = ({
  onFrameworkSelect,
  onBack
}: {
  ...
  const frameworks = [
    {
      ...
      icon: "activity",
      csvUrl: "/templates/opik-template.csv"
    },
    {
      id: "evidently",
      name: "Evidently",
      ...
      icon: "bar-chart",
      csvUrl: "/templates/evidently-template.csv"
    },
    {
      id: "deepeval",
      name: "DeepEval",
      ...
      icon: "check-circle",
      csvUrl: "/templates/deepeval-template.csv"
    },
    {
      id: "aif360",
      name: "Fair360",
      ...
      icon: "shield",
      csvUrl: "/templates/aif360-template.csv"
    },
    {
      id: "deepteam",
      name: "Deepteam",
      ...
      icon: "users",
      csvUrl: "/templates/deepteam-template.csv"
    }
  ];
  ...
  const handleDownload = (framework: { id: string; csvUrl: string }) => {
    // Download CSV template
    const link = document.createElement("a");
    link.href = framework.csvUrl;
    link.download = `DEMO_TEMPLATE_${framework.id.toUpperCase()}.csv`;
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
  };

  const handleContinue = (framework: { id: string }) => {
    // Proceed to form with selected framework
        ...
        <div className="relative p-8 pt-16">
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Select your preferred evaluation framework and proceed or download
              the template
            </p>
          </div>
              ...
              >
                ...
                <div className="relative z-10 flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {selectedFramework === framework.id && (
                      <div className="animate-in fade-in-50 slide-in-from-top-2 mt-4 flex gap-4 duration-300">
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            handleContinue(framework);
                          }}
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-2 rounded-lg bg-gray-200 px-4 py-2 text-sm font-medium text-gray-800 transition-colors duration-300 hover:bg-gray-300 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600"
                        >
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Click on a framework to select it and proceed or download the
...
export default FrameworkSelectionComponent;
