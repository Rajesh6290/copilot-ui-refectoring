...
import { ArrowRight, Building, Check, Lock } from "lucide-react";
import React, { useCallback, useMemo } from "react";
import PlatformPurchaseSchema from "../../schema/platfrom.schema";
import { FormValues } from "./PlatformPurchase";
              ...
              <div className="relative p-4 text-white sm:p-6 md:p-8 lg:p-10">
                <div className="sticky top-10">
                  <div className="mb-12 flex flex-col gap-3">
                    ...
                    <p className="text-lg font-semibold capitalize text-white/90">
                      ${" "}
                      {frequency === "month" || frequency === "one-time"
                        ? feature?.price_per_month
                        : feature?.price_per_year}{" "}
                      / {frequency === "one-time" ? "lifetime" : frequency}
                    </p>
                  ...
                  <div className="hidden border-t border-white/20 pt-8 md:block">
                    <p className="flex items-start gap-1 font-[family-name:var(--font-geist-sans)] text-sm tracking-wider text-white/80">
                      <Lock className="-mt-1 size-8 text-white" />{" "}
                      {
                  ...
                  <div
                    ...
                    onClick={() =>
                      window.open(
                        "https://www.cognitiveview.com/pricing-01",
                        "_blank"
                      )
                    }
                    onKeyDown={(e) => {
                    ...
                    className="mt-5 flex cursor-pointer items-center font-medium text-white"
                  >
                    <svg
            ...
            <div className="relative h-fit overflow-y-auto p-8 lg:w-3/5 lg:p-10">
              <div className="mx-auto">
                <Formik
                  ...
                  validationSchema={PlatformPurchaseSchema}
                  onSubmit={onSubmit}
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <Field
                                ...
                                name="description"
                                rows={3}
                                placeholder="Brief description of your company and needs"
                                className={`${inputClass} ${errors.description && touched.description ? inputError : ""}`}
                              />
                              <ErrorMessage
                                name="description"
                                component="div"
