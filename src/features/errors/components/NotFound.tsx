...
const NotFound = () => {
  return (
    <div className="h-dvh w-full">
      ...
      />
      <div className="min-w-screen relative flex min-h-screen items-center overflow-hidden bg-tertiary-100 p-5 lg:p-20">
        <div className="relative min-h-full min-w-full flex-1 items-center rounded-3xl bg-white p-10 text-center text-gray-800 shadow-xl md:flex md:text-left lg:p-20">
          <div className="w-full md:w-1/2">
            ...
            <div className="mb-10 font-light text-gray-600 md:mb-20">
              <h1 className="mb-10 text-3xl font-black uppercase text-tertiary lg:text-5xl">
                You seem to be lost!
              </h1>
            ...
            <div className="mb-20 md:mb-0">
              <button
                ...
                className="transform text-lg font-semibold text-tertiary outline-none transition-all hover:scale-110 hover:text-tertiary focus:outline-none"
              >
        ...
        <div className="pointer-events-none absolute -top-64 right-20 h-96 w-64 -rotate-45 transform rounded-full bg-yellow-100 bg-opacity-30 md:-top-96 md:right-32 md:h-full md:w-96"></div>
